...
export declare class FirebaseMessagingRequestHandler {
     ...
     */
    invokeHttpRequestHandlerForTopicSubscriptionResponse(host: string, path: string, methodName: string, requestData?: object): Promise<TopicSubscriptionResponse>;
    /**
     ...
     * @returns A promise that resolves with the {@link TopicSubscriptionResponse}.
     */
    invokeHttp2RequestHandlerForTopicSubscriptionResponse(host: string, path: string, methodName: string, requestData: object | undefined, http2SessionHandler: Http2SessionHandler): Promise<TopicSubscriptionResponse>;
